...
const comida1 = prompt("Digite a sua primeira comida preferida");
const comida2 = prompt("Digite a sua segunda comida preferida");
const comida3 = prompt("Digite a sua terceira comida preferida");
